                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="{{route('page.contact')}}" class="nav-item nav-link active">Contact</a>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="text-center mx-auto" style="max-width: 700px;">
                                ...
                                <p class="mb-4">We’d love to hear from you! Have a question about our fresh produce, an order, or anything else? Send us a message and our friendly team will get back to you as soon as possible.</a>.</p>
                            </div>
                        </div>
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-5">
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Address</h4>
                                    <p class="mb-2">City of Naga, Cebu</p>
                                </div>
                            </div>
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Mail Us</h4>
                                    <p class="mb-2">FruityPop@gmail.com</p>
                                </div>
                            </div>
