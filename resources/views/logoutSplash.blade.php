...
<head>
  ...
  <title>FruityPop - Logging Out...</title>
...
<body>
  <div id="splash-screen">
    <div class="splash-card">
      <i class="fa-solid fa-hand-peace splash-logo"></i>
      <h1>Logging Out...</h1>
      <p class="tagline">Thanks for visiting FruityPop 🍃</p>
      ...
      <p class="message">See you again soon!</p>
    </div>

    <footer>© 2025 FruityPop. Freshness never fades. 🌱</footer>
  </div>
