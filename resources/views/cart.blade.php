                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        <img src="../../../assets/img/vegetable-item-5.jpg" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="" alt="">
                                    </div>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        <img src="../../../assets/img/vegetable-item-2.jpg" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="" alt="">
                                    </div>
                                </th>
                                <td>
                    ...
                    <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                        <div class="bg-light rounded">
                            <div class="p-4">
                                ...
                                <p class="mb-0 text-end">Sanfernando, Cabatbatan</p>
                            </div>
