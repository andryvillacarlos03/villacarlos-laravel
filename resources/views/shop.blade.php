                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="{{route('page.shop')}}" class="nav-item nav-link active">Shop</a>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-start">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex mb-2">
                                                    <h5 class="fw-bold me-2">4.20 $</h5>
                                                    <h5 class="text-danger text-decoration-line-through">7.11 $</h5>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row g-4 justify-content-center">
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item h-100">
                                            <div class="fruite-img">
                                                <img src="../../../assets/img/vegetable-item-10.jpg" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Garlic</h4>
                                                <p>Aromatic, robust garlic — nature’s flavorful boost for savory, unforgettable meals.</p>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="../../../assets/img/vegetable-item-7.jpg" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Vegetable</div>
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Carrots</h4>
                                                <p>Sweet, crunchy carrots — packed with natural goodness for snacks, salads, and hearty meals.</p>
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="../../../assets/img/vegetable-item-11.jpg" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Vegetable</div>
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Radish</h4>
                                                <p>Crisp, peppery radishes — a fresh, crunchy bite to brighten up salads and snacks.</p>
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Banana</h4>
                                                <p>Soft, creamy, and naturally energizing — the perfect go-anywhere, anytime, wholesome snack.</p>
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Oranges</h4>
                                                <p>Bright, juicy, and full of vitamin C — a zesty, uplifting burst of freshness in every sunny peel.</p>
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Raspberries</h4>
                                                <p>Delicately sweet with a hint of tart — nature’s perfect pop of flavor, color, and vibrant.</p>
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    <p class="text-dark fs-5 fw-bold mb-0">$4.99 / kg</p>
                                                    <a href="#" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                                                </div>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Water Melon</h4>
                                                <p>Cool, crisp, and hydrating — summer’s favorite fruit in every juicy, refreshing, sun-ripened bite.</p>
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Strawberries</h4>
                                                <p>Lusciously red and naturally sweet — perfect for desserts, smoothies guilt-free indulgence.</p>
                                                <div class="d-flex justify-content-between flex-lg-wrap">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>FuityPop</a>, All right reserved.</span>
                    </div>
